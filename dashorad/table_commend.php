...
$AllComment = new Comments();
$SelectAllComment = $AllComment->SelectAllComment();
...
<table class="ml-[340px] border-collapse w-[75%] bg-white shadow-lg rounded-lg">
    <thead class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white">
        <tr>
        <th class=" font-bold  border  text-center"></th>
            <th class="p-3 font-bold uppercase border border-gray-300 text-center">Article</th>
            <th class="p-3 font-bold uppercase border border-gray-300 text-center">Comment</th>
            <th class="p-3 font-bold uppercase border border-gray-300 text-center">Actions</th>
        </tr>
    </thead>
    <?php foreach($SelectAllComment as $tag): ?>
    <tbody>
        ...
        <tr class="bg-white hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
            ...
            <img src="<?= $tag->image ?>" alt="Article Image" class="w-10 h-10 object-cover  rounded-full mx-auto">
        </td>
            ...
            <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                ...
                <a href="table_commend.php?delete=<?= $tag->comments.id ?>" class="text-red-500 hover:text-red-700 font-medium underline pl-6">
