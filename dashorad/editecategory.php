...
if (isset($_GET['edite'])) {
    $id = $_GET['edite'];
    $category = $categorys->afficherCategoryById($id);
}
if (isset($_POST['submit_btn'])) {
   ...
   $names = $_POST['names'];
    ...
    $categorys->Editecategory($names ,$CategoryID);
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-[90%] sm:w-[400px]">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="names" value="<?= $category['names'] ?>" name="names"  class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>
